...
| [`after-action-review`](skills/after-action-review/SKILL.md) | Helps project teams turn launches, initiatives, migrations, and incidents into concrete system learning. |
